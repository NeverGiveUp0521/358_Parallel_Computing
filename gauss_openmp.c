...
/* In this part, we use OpenMP to do parallel computing with dynamic scheduling.
 * We just set the #pragma omp parallel between the first and second "for" loop 
 * with the parameters and number of the threads. Then we let "omp" to divide the  
 * "for" loops with dynamic scheduling.
 */
